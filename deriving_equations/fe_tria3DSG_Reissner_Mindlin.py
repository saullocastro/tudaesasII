...
c = x3 - x1
d = y3 - y1
BDSGD = 1/(2*A)*Matrix([[0, 0, 0, b - d, 0,      0, 0, 0, d, 0,    0, 0, 0, -b, 0],
                        [0, 0, 0, 0, 0, c - a,   0, 0, 0, 0, -c,   0, 0, a],
                        [0, 0, 0, c - a, b - d,  0, 0, 0, -c, d,   0, a, -b],
BDSGE = 1/(2*A)*Matrix([[0, 0, (b - d), A, 0, 0, 0, d, a*d/2, b*d/2, 0, 0, -b, -b*c/2, -b*d/2],
                        [0, 0, (c - a), 0, A, 0, 0, -c, -a*c/2, -b*c/2, 0, 0, a, a*c/2, a*d/2]])
