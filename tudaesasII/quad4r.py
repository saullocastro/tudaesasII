...
class Quad4R(object):
    ...
    """
    __slots__ = ['n1', 'n2', 'n3', 'n4', 'A', 'B', 'D', 'Atrans', 'h', 'rho',
            'scf13', 'scf23']
    def __init__(self):
        self.n1 = None
        self.n2 = None
...
def update_K(quad, nid_pos, ncoords, K):
    ...
    A44 = A44*quad.scf23
    A45 = A45*min(quad.scf23, quad.scf13)
    A55 = A55*quad.scf13

    area = (np.cross([x2 - x1, y2 - y1], [x4 - x1, y4 - y1])/2 +
    ...
    Eu = 10*0.1*A11/(1 + 1/area)
    Ev = 10*0.1*A22/(1 + 1/area)
    Ephix = 12*0.1*D11/(1 + 1/area)
    Ephiy = 12*0.1*D22/(1 + 1/area)
    Ew = 5*(Ephix + Ephiy)/2
    ...
    K[2+c1, 2+c1] += detJ*wij*(Ew*gamma1**2 + N1x*(A45*N1y + A55*N1x) + N1y*(A44*N1y + A45*N1x))
    K[2+c1, 3+c1] += N1*detJ*wij*(A45*N1y + A55*N1x)
    K[2+c1, 4+c1] += N1*detJ*wij*(A44*N1y + A45*N1x)
    K[2+c1, 2+c2] += detJ*wij*(Ew*gamma1*gamma2 + N2x*(A45*N1y + A55*N1x) + N2y*(A44*N1y + A45*N1x))
    K[2+c1, 3+c2] += N2*detJ*wij*(A45*N1y + A55*N1x)
    K[2+c1, 4+c2] += N2*detJ*wij*(A44*N1y + A45*N1x)
    K[2+c1, 2+c3] += detJ*wij*(Ew*gamma1*gamma3 + N3x*(A45*N1y + A55*N1x) + N3y*(A44*N1y + A45*N1x))
    K[2+c1, 3+c3] += N3*detJ*wij*(A45*N1y + A55*N1x)
    K[2+c1, 4+c3] += N3*detJ*wij*(A44*N1y + A45*N1x)
    K[2+c1, 2+c4] += detJ*wij*(Ew*gamma1*gamma4 + N4x*(A45*N1y + A55*N1x) + N4y*(A44*N1y + A45*N1x))
    K[2+c1, 3+c4] += N4*detJ*wij*(A45*N1y + A55*N1x)
    K[2+c1, 4+c4] += N4*detJ*wij*(A44*N1y + A45*N1x)
    K[3+c1, 0+c1] += detJ*wij*(N1x*(B11*N1x + B16*N1y) + N1y*(B16*N1x + B66*N1y))
    K[3+c1, 1+c1] += detJ*wij*(N1x*(B16*N1x + B66*N1y) + N1y*(B12*N1x + B26*N1y))
    K[3+c1, 2+c1] += detJ*wij*(A45*N1*N1y + A55*N1*N1x)
    K[3+c1, 3+c1] += detJ*wij*(A55*N1**2 + Ephix*gamma1**2 + N1x*(D11*N1x + D16*N1y) + N1y*(D16*N1x + D66*N1y))
    K[3+c1, 4+c1] += detJ*wij*(A45*N1**2 + N1x*(D16*N1x + D66*N1y) + N1y*(D12*N1x + D26*N1y))
    K[3+c1, 0+c2] += detJ*wij*(N2x*(B11*N1x + B16*N1y) + N2y*(B16*N1x + B66*N1y))
    K[3+c1, 1+c2] += detJ*wij*(N2x*(B16*N1x + B66*N1y) + N2y*(B12*N1x + B26*N1y))
    K[3+c1, 2+c2] += detJ*wij*(A45*N1*N2y + A55*N1*N2x)
    K[3+c1, 3+c2] += detJ*wij*(A55*N1*N2 + Ephix*gamma1*gamma2 + N2x*(D11*N1x + D16*N1y) + N2y*(D16*N1x + D66*N1y))
    K[3+c1, 4+c2] += detJ*wij*(A45*N1*N2 + N2x*(D16*N1x + D66*N1y) + N2y*(D12*N1x + D26*N1y))
    K[3+c1, 0+c3] += detJ*wij*(N3x*(B11*N1x + B16*N1y) + N3y*(B16*N1x + B66*N1y))
    K[3+c1, 1+c3] += detJ*wij*(N3x*(B16*N1x + B66*N1y) + N3y*(B12*N1x + B26*N1y))
    K[3+c1, 2+c3] += detJ*wij*(A45*N1*N3y + A55*N1*N3x)
    K[3+c1, 3+c3] += detJ*wij*(A55*N1*N3 + Ephix*gamma1*gamma3 + N3x*(D11*N1x + D16*N1y) + N3y*(D16*N1x + D66*N1y))
    K[3+c1, 4+c3] += detJ*wij*(A45*N1*N3 + N3x*(D16*N1x + D66*N1y) + N3y*(D12*N1x + D26*N1y))
    K[3+c1, 0+c4] += detJ*wij*(N4x*(B11*N1x + B16*N1y) + N4y*(B16*N1x + B66*N1y))
    K[3+c1, 1+c4] += detJ*wij*(N4x*(B16*N1x + B66*N1y) + N4y*(B12*N1x + B26*N1y))
    K[3+c1, 2+c4] += detJ*wij*(A45*N1*N4y + A55*N1*N4x)
    K[3+c1, 3+c4] += detJ*wij*(A55*N1*N4 + Ephix*gamma1*gamma4 + N4x*(D11*N1x + D16*N1y) + N4y*(D16*N1x + D66*N1y))
    K[3+c1, 4+c4] += detJ*wij*(A45*N1*N4 + N4x*(D16*N1x + D66*N1y) + N4y*(D12*N1x + D26*N1y))
    K[4+c1, 0+c1] += detJ*wij*(N1x*(B12*N1y + B16*N1x) + N1y*(B26*N1y + B66*N1x))
    K[4+c1, 1+c1] += detJ*wij*(N1x*(B26*N1y + B66*N1x) + N1y*(B22*N1y + B26*N1x))
    K[4+c1, 2+c1] += detJ*wij*(A44*N1*N1y + A45*N1*N1x)
    K[4+c1, 3+c1] += detJ*wij*(A45*N1**2 + N1x*(D12*N1y + D16*N1x) + N1y*(D26*N1y + D66*N1x))
    K[4+c1, 4+c1] += detJ*wij*(A44*N1**2 + Ephiy*gamma1**2 + N1x*(D26*N1y + D66*N1x) + N1y*(D22*N1y + D26*N1x))
    K[4+c1, 0+c2] += detJ*wij*(N2x*(B12*N1y + B16*N1x) + N2y*(B26*N1y + B66*N1x))
    K[4+c1, 1+c2] += detJ*wij*(N2x*(B26*N1y + B66*N1x) + N2y*(B22*N1y + B26*N1x))
    K[4+c1, 2+c2] += detJ*wij*(A44*N1*N2y + A45*N1*N2x)
    K[4+c1, 3+c2] += detJ*wij*(A45*N1*N2 + N2x*(D12*N1y + D16*N1x) + N2y*(D26*N1y + D66*N1x))
    K[4+c1, 4+c2] += detJ*wij*(A44*N1*N2 + Ephiy*gamma1*gamma2 + N2x*(D26*N1y + D66*N1x) + N2y*(D22*N1y + D26*N1x))
    K[4+c1, 0+c3] += detJ*wij*(N3x*(B12*N1y + B16*N1x) + N3y*(B26*N1y + B66*N1x))
    K[4+c1, 1+c3] += detJ*wij*(N3x*(B26*N1y + B66*N1x) + N3y*(B22*N1y + B26*N1x))
    K[4+c1, 2+c3] += detJ*wij*(A44*N1*N3y + A45*N1*N3x)
    K[4+c1, 3+c3] += detJ*wij*(A45*N1*N3 + N3x*(D12*N1y + D16*N1x) + N3y*(D26*N1y + D66*N1x))
    K[4+c1, 4+c3] += detJ*wij*(A44*N1*N3 + Ephiy*gamma1*gamma3 + N3x*(D26*N1y + D66*N1x) + N3y*(D22*N1y + D26*N1x))
    K[4+c1, 0+c4] += detJ*wij*(N4x*(B12*N1y + B16*N1x) + N4y*(B26*N1y + B66*N1x))
    K[4+c1, 1+c4] += detJ*wij*(N4x*(B26*N1y + B66*N1x) + N4y*(B22*N1y + B26*N1x))
    K[4+c1, 2+c4] += detJ*wij*(A44*N1*N4y + A45*N1*N4x)
    K[4+c1, 3+c4] += detJ*wij*(A45*N1*N4 + N4x*(D12*N1y + D16*N1x) + N4y*(D26*N1y + D66*N1x))
    K[4+c1, 4+c4] += detJ*wij*(A44*N1*N4 + Ephiy*gamma1*gamma4 + N4x*(D26*N1y + D66*N1x) + N4y*(D22*N1y + D26*N1x))
    ...
    K[2+c2, 2+c1] += detJ*wij*(Ew*gamma1*gamma2 + N1x*(A45*N2y + A55*N2x) + N1y*(A44*N2y + A45*N2x))
    K[2+c2, 3+c1] += N1*detJ*wij*(A45*N2y + A55*N2x)
    K[2+c2, 4+c1] += N1*detJ*wij*(A44*N2y + A45*N2x)
    K[2+c2, 2+c2] += detJ*wij*(Ew*gamma2**2 + N2x*(A45*N2y + A55*N2x) + N2y*(A44*N2y + A45*N2x))
    K[2+c2, 3+c2] += N2*detJ*wij*(A45*N2y + A55*N2x)
    K[2+c2, 4+c2] += N2*detJ*wij*(A44*N2y + A45*N2x)
    K[2+c2, 2+c3] += detJ*wij*(Ew*gamma2*gamma3 + N3x*(A45*N2y + A55*N2x) + N3y*(A44*N2y + A45*N2x))
    K[2+c2, 3+c3] += N3*detJ*wij*(A45*N2y + A55*N2x)
    K[2+c2, 4+c3] += N3*detJ*wij*(A44*N2y + A45*N2x)
    K[2+c2, 2+c4] += detJ*wij*(Ew*gamma2*gamma4 + N4x*(A45*N2y + A55*N2x) + N4y*(A44*N2y + A45*N2x))
    K[2+c2, 3+c4] += N4*detJ*wij*(A45*N2y + A55*N2x)
    K[2+c2, 4+c4] += N4*detJ*wij*(A44*N2y + A45*N2x)
    K[3+c2, 0+c1] += detJ*wij*(N1x*(B11*N2x + B16*N2y) + N1y*(B16*N2x + B66*N2y))
    K[3+c2, 1+c1] += detJ*wij*(N1x*(B16*N2x + B66*N2y) + N1y*(B12*N2x + B26*N2y))
    K[3+c2, 2+c1] += detJ*wij*(A45*N1y*N2 + A55*N1x*N2)
    K[3+c2, 3+c1] += detJ*wij*(A55*N1*N2 + Ephix*gamma1*gamma2 + N1x*(D11*N2x + D16*N2y) + N1y*(D16*N2x + D66*N2y))
    K[3+c2, 4+c1] += detJ*wij*(A45*N1*N2 + N1x*(D16*N2x + D66*N2y) + N1y*(D12*N2x + D26*N2y))
    K[3+c2, 0+c2] += detJ*wij*(N2x*(B11*N2x + B16*N2y) + N2y*(B16*N2x + B66*N2y))
    K[3+c2, 1+c2] += detJ*wij*(N2x*(B16*N2x + B66*N2y) + N2y*(B12*N2x + B26*N2y))
    K[3+c2, 2+c2] += detJ*wij*(A45*N2*N2y + A55*N2*N2x)
    K[3+c2, 3+c2] += detJ*wij*(A55*N2**2 + Ephix*gamma2**2 + N2x*(D11*N2x + D16*N2y) + N2y*(D16*N2x + D66*N2y))
    K[3+c2, 4+c2] += detJ*wij*(A45*N2**2 + N2x*(D16*N2x + D66*N2y) + N2y*(D12*N2x + D26*N2y))
    K[3+c2, 0+c3] += detJ*wij*(N3x*(B11*N2x + B16*N2y) + N3y*(B16*N2x + B66*N2y))
    K[3+c2, 1+c3] += detJ*wij*(N3x*(B16*N2x + B66*N2y) + N3y*(B12*N2x + B26*N2y))
    K[3+c2, 2+c3] += detJ*wij*(A45*N2*N3y + A55*N2*N3x)
    K[3+c2, 3+c3] += detJ*wij*(A55*N2*N3 + Ephix*gamma2*gamma3 + N3x*(D11*N2x + D16*N2y) + N3y*(D16*N2x + D66*N2y))
    K[3+c2, 4+c3] += detJ*wij*(A45*N2*N3 + N3x*(D16*N2x + D66*N2y) + N3y*(D12*N2x + D26*N2y))
    K[3+c2, 0+c4] += detJ*wij*(N4x*(B11*N2x + B16*N2y) + N4y*(B16*N2x + B66*N2y))
    K[3+c2, 1+c4] += detJ*wij*(N4x*(B16*N2x + B66*N2y) + N4y*(B12*N2x + B26*N2y))
    K[3+c2, 2+c4] += detJ*wij*(A45*N2*N4y + A55*N2*N4x)
    K[3+c2, 3+c4] += detJ*wij*(A55*N2*N4 + Ephix*gamma2*gamma4 + N4x*(D11*N2x + D16*N2y) + N4y*(D16*N2x + D66*N2y))
    K[3+c2, 4+c4] += detJ*wij*(A45*N2*N4 + N4x*(D16*N2x + D66*N2y) + N4y*(D12*N2x + D26*N2y))
    K[4+c2, 0+c1] += detJ*wij*(N1x*(B12*N2y + B16*N2x) + N1y*(B26*N2y + B66*N2x))
    K[4+c2, 1+c1] += detJ*wij*(N1x*(B26*N2y + B66*N2x) + N1y*(B22*N2y + B26*N2x))
    K[4+c2, 2+c1] += detJ*wij*(A44*N1y*N2 + A45*N1x*N2)
    K[4+c2, 3+c1] += detJ*wij*(A45*N1*N2 + N1x*(D12*N2y + D16*N2x) + N1y*(D26*N2y + D66*N2x))
    K[4+c2, 4+c1] += detJ*wij*(A44*N1*N2 + Ephiy*gamma1*gamma2 + N1x*(D26*N2y + D66*N2x) + N1y*(D22*N2y + D26*N2x))
    K[4+c2, 0+c2] += detJ*wij*(N2x*(B12*N2y + B16*N2x) + N2y*(B26*N2y + B66*N2x))
    K[4+c2, 1+c2] += detJ*wij*(N2x*(B26*N2y + B66*N2x) + N2y*(B22*N2y + B26*N2x))
    K[4+c2, 2+c2] += detJ*wij*(A44*N2*N2y + A45*N2*N2x)
    K[4+c2, 3+c2] += detJ*wij*(A45*N2**2 + N2x*(D12*N2y + D16*N2x) + N2y*(D26*N2y + D66*N2x))
    K[4+c2, 4+c2] += detJ*wij*(A44*N2**2 + Ephiy*gamma2**2 + N2x*(D26*N2y + D66*N2x) + N2y*(D22*N2y + D26*N2x))
    K[4+c2, 0+c3] += detJ*wij*(N3x*(B12*N2y + B16*N2x) + N3y*(B26*N2y + B66*N2x))
    K[4+c2, 1+c3] += detJ*wij*(N3x*(B26*N2y + B66*N2x) + N3y*(B22*N2y + B26*N2x))
    K[4+c2, 2+c3] += detJ*wij*(A44*N2*N3y + A45*N2*N3x)
    K[4+c2, 3+c3] += detJ*wij*(A45*N2*N3 + N3x*(D12*N2y + D16*N2x) + N3y*(D26*N2y + D66*N2x))
    K[4+c2, 4+c3] += detJ*wij*(A44*N2*N3 + Ephiy*gamma2*gamma3 + N3x*(D26*N2y + D66*N2x) + N3y*(D22*N2y + D26*N2x))
    K[4+c2, 0+c4] += detJ*wij*(N4x*(B12*N2y + B16*N2x) + N4y*(B26*N2y + B66*N2x))
    K[4+c2, 1+c4] += detJ*wij*(N4x*(B26*N2y + B66*N2x) + N4y*(B22*N2y + B26*N2x))
    K[4+c2, 2+c4] += detJ*wij*(A44*N2*N4y + A45*N2*N4x)
    K[4+c2, 3+c4] += detJ*wij*(A45*N2*N4 + N4x*(D12*N2y + D16*N2x) + N4y*(D26*N2y + D66*N2x))
    K[4+c2, 4+c4] += detJ*wij*(A44*N2*N4 + Ephiy*gamma2*gamma4 + N4x*(D26*N2y + D66*N2x) + N4y*(D22*N2y + D26*N2x))
    ...
    K[2+c3, 2+c1] += detJ*wij*(Ew*gamma1*gamma3 + N1x*(A45*N3y + A55*N3x) + N1y*(A44*N3y + A45*N3x))
    K[2+c3, 3+c1] += N1*detJ*wij*(A45*N3y + A55*N3x)
    K[2+c3, 4+c1] += N1*detJ*wij*(A44*N3y + A45*N3x)
    K[2+c3, 2+c2] += detJ*wij*(Ew*gamma2*gamma3 + N2x*(A45*N3y + A55*N3x) + N2y*(A44*N3y + A45*N3x))
    K[2+c3, 3+c2] += N2*detJ*wij*(A45*N3y + A55*N3x)
    K[2+c3, 4+c2] += N2*detJ*wij*(A44*N3y + A45*N3x)
    K[2+c3, 2+c3] += detJ*wij*(Ew*gamma3**2 + N3x*(A45*N3y + A55*N3x) + N3y*(A44*N3y + A45*N3x))
    K[2+c3, 3+c3] += N3*detJ*wij*(A45*N3y + A55*N3x)
    K[2+c3, 4+c3] += N3*detJ*wij*(A44*N3y + A45*N3x)
    K[2+c3, 2+c4] += detJ*wij*(Ew*gamma3*gamma4 + N4x*(A45*N3y + A55*N3x) + N4y*(A44*N3y + A45*N3x))
    K[2+c3, 3+c4] += N4*detJ*wij*(A45*N3y + A55*N3x)
    K[2+c3, 4+c4] += N4*detJ*wij*(A44*N3y + A45*N3x)
    K[3+c3, 0+c1] += detJ*wij*(N1x*(B11*N3x + B16*N3y) + N1y*(B16*N3x + B66*N3y))
    K[3+c3, 1+c1] += detJ*wij*(N1x*(B16*N3x + B66*N3y) + N1y*(B12*N3x + B26*N3y))
    K[3+c3, 2+c1] += detJ*wij*(A45*N1y*N3 + A55*N1x*N3)
    K[3+c3, 3+c1] += detJ*wij*(A55*N1*N3 + Ephix*gamma1*gamma3 + N1x*(D11*N3x + D16*N3y) + N1y*(D16*N3x + D66*N3y))
    K[3+c3, 4+c1] += detJ*wij*(A45*N1*N3 + N1x*(D16*N3x + D66*N3y) + N1y*(D12*N3x + D26*N3y))
    K[3+c3, 0+c2] += detJ*wij*(N2x*(B11*N3x + B16*N3y) + N2y*(B16*N3x + B66*N3y))
    K[3+c3, 1+c2] += detJ*wij*(N2x*(B16*N3x + B66*N3y) + N2y*(B12*N3x + B26*N3y))
    K[3+c3, 2+c2] += detJ*wij*(A45*N2y*N3 + A55*N2x*N3)
    K[3+c3, 3+c2] += detJ*wij*(A55*N2*N3 + Ephix*gamma2*gamma3 + N2x*(D11*N3x + D16*N3y) + N2y*(D16*N3x + D66*N3y))
    K[3+c3, 4+c2] += detJ*wij*(A45*N2*N3 + N2x*(D16*N3x + D66*N3y) + N2y*(D12*N3x + D26*N3y))
    K[3+c3, 0+c3] += detJ*wij*(N3x*(B11*N3x + B16*N3y) + N3y*(B16*N3x + B66*N3y))
    K[3+c3, 1+c3] += detJ*wij*(N3x*(B16*N3x + B66*N3y) + N3y*(B12*N3x + B26*N3y))
    K[3+c3, 2+c3] += detJ*wij*(A45*N3*N3y + A55*N3*N3x)
    K[3+c3, 3+c3] += detJ*wij*(A55*N3**2 + Ephix*gamma3**2 + N3x*(D11*N3x + D16*N3y) + N3y*(D16*N3x + D66*N3y))
    K[3+c3, 4+c3] += detJ*wij*(A45*N3**2 + N3x*(D16*N3x + D66*N3y) + N3y*(D12*N3x + D26*N3y))
    K[3+c3, 0+c4] += detJ*wij*(N4x*(B11*N3x + B16*N3y) + N4y*(B16*N3x + B66*N3y))
    K[3+c3, 1+c4] += detJ*wij*(N4x*(B16*N3x + B66*N3y) + N4y*(B12*N3x + B26*N3y))
    K[3+c3, 2+c4] += detJ*wij*(A45*N3*N4y + A55*N3*N4x)
    K[3+c3, 3+c4] += detJ*wij*(A55*N3*N4 + Ephix*gamma3*gamma4 + N4x*(D11*N3x + D16*N3y) + N4y*(D16*N3x + D66*N3y))
    K[3+c3, 4+c4] += detJ*wij*(A45*N3*N4 + N4x*(D16*N3x + D66*N3y) + N4y*(D12*N3x + D26*N3y))
    K[4+c3, 0+c1] += detJ*wij*(N1x*(B12*N3y + B16*N3x) + N1y*(B26*N3y + B66*N3x))
    K[4+c3, 1+c1] += detJ*wij*(N1x*(B26*N3y + B66*N3x) + N1y*(B22*N3y + B26*N3x))
    K[4+c3, 2+c1] += detJ*wij*(A44*N1y*N3 + A45*N1x*N3)
    K[4+c3, 3+c1] += detJ*wij*(A45*N1*N3 + N1x*(D12*N3y + D16*N3x) + N1y*(D26*N3y + D66*N3x))
    K[4+c3, 4+c1] += detJ*wij*(A44*N1*N3 + Ephiy*gamma1*gamma3 + N1x*(D26*N3y + D66*N3x) + N1y*(D22*N3y + D26*N3x))
    K[4+c3, 0+c2] += detJ*wij*(N2x*(B12*N3y + B16*N3x) + N2y*(B26*N3y + B66*N3x))
    K[4+c3, 1+c2] += detJ*wij*(N2x*(B26*N3y + B66*N3x) + N2y*(B22*N3y + B26*N3x))
    K[4+c3, 2+c2] += detJ*wij*(A44*N2y*N3 + A45*N2x*N3)
    K[4+c3, 3+c2] += detJ*wij*(A45*N2*N3 + N2x*(D12*N3y + D16*N3x) + N2y*(D26*N3y + D66*N3x))
    K[4+c3, 4+c2] += detJ*wij*(A44*N2*N3 + Ephiy*gamma2*gamma3 + N2x*(D26*N3y + D66*N3x) + N2y*(D22*N3y + D26*N3x))
    K[4+c3, 0+c3] += detJ*wij*(N3x*(B12*N3y + B16*N3x) + N3y*(B26*N3y + B66*N3x))
    K[4+c3, 1+c3] += detJ*wij*(N3x*(B26*N3y + B66*N3x) + N3y*(B22*N3y + B26*N3x))
    K[4+c3, 2+c3] += detJ*wij*(A44*N3*N3y + A45*N3*N3x)
    K[4+c3, 3+c3] += detJ*wij*(A45*N3**2 + N3x*(D12*N3y + D16*N3x) + N3y*(D26*N3y + D66*N3x))
    K[4+c3, 4+c3] += detJ*wij*(A44*N3**2 + Ephiy*gamma3**2 + N3x*(D26*N3y + D66*N3x) + N3y*(D22*N3y + D26*N3x))
    K[4+c3, 0+c4] += detJ*wij*(N4x*(B12*N3y + B16*N3x) + N4y*(B26*N3y + B66*N3x))
    K[4+c3, 1+c4] += detJ*wij*(N4x*(B26*N3y + B66*N3x) + N4y*(B22*N3y + B26*N3x))
    K[4+c3, 2+c4] += detJ*wij*(A44*N3*N4y + A45*N3*N4x)
    K[4+c3, 3+c4] += detJ*wij*(A45*N3*N4 + N4x*(D12*N3y + D16*N3x) + N4y*(D26*N3y + D66*N3x))
    K[4+c3, 4+c4] += detJ*wij*(A44*N3*N4 + Ephiy*gamma3*gamma4 + N4x*(D26*N3y + D66*N3x) + N4y*(D22*N3y + D26*N3x))
    ...
    K[2+c4, 2+c1] += detJ*wij*(Ew*gamma1*gamma4 + N1x*(A45*N4y + A55*N4x) + N1y*(A44*N4y + A45*N4x))
    K[2+c4, 3+c1] += N1*detJ*wij*(A45*N4y + A55*N4x)
    K[2+c4, 4+c1] += N1*detJ*wij*(A44*N4y + A45*N4x)
    K[2+c4, 2+c2] += detJ*wij*(Ew*gamma2*gamma4 + N2x*(A45*N4y + A55*N4x) + N2y*(A44*N4y + A45*N4x))
    K[2+c4, 3+c2] += N2*detJ*wij*(A45*N4y + A55*N4x)
    K[2+c4, 4+c2] += N2*detJ*wij*(A44*N4y + A45*N4x)
    K[2+c4, 2+c3] += detJ*wij*(Ew*gamma3*gamma4 + N3x*(A45*N4y + A55*N4x) + N3y*(A44*N4y + A45*N4x))
    K[2+c4, 3+c3] += N3*detJ*wij*(A45*N4y + A55*N4x)
    K[2+c4, 4+c3] += N3*detJ*wij*(A44*N4y + A45*N4x)
    K[2+c4, 2+c4] += detJ*wij*(Ew*gamma4**2 + N4x*(A45*N4y + A55*N4x) + N4y*(A44*N4y + A45*N4x))
    K[2+c4, 3+c4] += N4*detJ*wij*(A45*N4y + A55*N4x)
    K[2+c4, 4+c4] += N4*detJ*wij*(A44*N4y + A45*N4x)
    K[3+c4, 0+c1] += detJ*wij*(N1x*(B11*N4x + B16*N4y) + N1y*(B16*N4x + B66*N4y))
    K[3+c4, 1+c1] += detJ*wij*(N1x*(B16*N4x + B66*N4y) + N1y*(B12*N4x + B26*N4y))
    K[3+c4, 2+c1] += detJ*wij*(A45*N1y*N4 + A55*N1x*N4)
    K[3+c4, 3+c1] += detJ*wij*(A55*N1*N4 + Ephix*gamma1*gamma4 + N1x*(D11*N4x + D16*N4y) + N1y*(D16*N4x + D66*N4y))
    K[3+c4, 4+c1] += detJ*wij*(A45*N1*N4 + N1x*(D16*N4x + D66*N4y) + N1y*(D12*N4x + D26*N4y))
    K[3+c4, 0+c2] += detJ*wij*(N2x*(B11*N4x + B16*N4y) + N2y*(B16*N4x + B66*N4y))
    K[3+c4, 1+c2] += detJ*wij*(N2x*(B16*N4x + B66*N4y) + N2y*(B12*N4x + B26*N4y))
    K[3+c4, 2+c2] += detJ*wij*(A45*N2y*N4 + A55*N2x*N4)
    K[3+c4, 3+c2] += detJ*wij*(A55*N2*N4 + Ephix*gamma2*gamma4 + N2x*(D11*N4x + D16*N4y) + N2y*(D16*N4x + D66*N4y))
    K[3+c4, 4+c2] += detJ*wij*(A45*N2*N4 + N2x*(D16*N4x + D66*N4y) + N2y*(D12*N4x + D26*N4y))
    K[3+c4, 0+c3] += detJ*wij*(N3x*(B11*N4x + B16*N4y) + N3y*(B16*N4x + B66*N4y))
    K[3+c4, 1+c3] += detJ*wij*(N3x*(B16*N4x + B66*N4y) + N3y*(B12*N4x + B26*N4y))
    K[3+c4, 2+c3] += detJ*wij*(A45*N3y*N4 + A55*N3x*N4)
    K[3+c4, 3+c3] += detJ*wij*(A55*N3*N4 + Ephix*gamma3*gamma4 + N3x*(D11*N4x + D16*N4y) + N3y*(D16*N4x + D66*N4y))
    K[3+c4, 4+c3] += detJ*wij*(A45*N3*N4 + N3x*(D16*N4x + D66*N4y) + N3y*(D12*N4x + D26*N4y))
    K[3+c4, 0+c4] += detJ*wij*(N4x*(B11*N4x + B16*N4y) + N4y*(B16*N4x + B66*N4y))
    K[3+c4, 1+c4] += detJ*wij*(N4x*(B16*N4x + B66*N4y) + N4y*(B12*N4x + B26*N4y))
    K[3+c4, 2+c4] += detJ*wij*(A45*N4*N4y + A55*N4*N4x)
    K[3+c4, 3+c4] += detJ*wij*(A55*N4**2 + Ephix*gamma4**2 + N4x*(D11*N4x + D16*N4y) + N4y*(D16*N4x + D66*N4y))
    K[3+c4, 4+c4] += detJ*wij*(A45*N4**2 + N4x*(D16*N4x + D66*N4y) + N4y*(D12*N4x + D26*N4y))
    K[4+c4, 0+c1] += detJ*wij*(N1x*(B12*N4y + B16*N4x) + N1y*(B26*N4y + B66*N4x))
    K[4+c4, 1+c1] += detJ*wij*(N1x*(B26*N4y + B66*N4x) + N1y*(B22*N4y + B26*N4x))
    K[4+c4, 2+c1] += detJ*wij*(A44*N1y*N4 + A45*N1x*N4)
    K[4+c4, 3+c1] += detJ*wij*(A45*N1*N4 + N1x*(D12*N4y + D16*N4x) + N1y*(D26*N4y + D66*N4x))
    K[4+c4, 4+c1] += detJ*wij*(A44*N1*N4 + Ephiy*gamma1*gamma4 + N1x*(D26*N4y + D66*N4x) + N1y*(D22*N4y + D26*N4x))
    K[4+c4, 0+c2] += detJ*wij*(N2x*(B12*N4y + B16*N4x) + N2y*(B26*N4y + B66*N4x))
    K[4+c4, 1+c2] += detJ*wij*(N2x*(B26*N4y + B66*N4x) + N2y*(B22*N4y + B26*N4x))
    K[4+c4, 2+c2] += detJ*wij*(A44*N2y*N4 + A45*N2x*N4)
    K[4+c4, 3+c2] += detJ*wij*(A45*N2*N4 + N2x*(D12*N4y + D16*N4x) + N2y*(D26*N4y + D66*N4x))
    K[4+c4, 4+c2] += detJ*wij*(A44*N2*N4 + Ephiy*gamma2*gamma4 + N2x*(D26*N4y + D66*N4x) + N2y*(D22*N4y + D26*N4x))
    K[4+c4, 0+c3] += detJ*wij*(N3x*(B12*N4y + B16*N4x) + N3y*(B26*N4y + B66*N4x))
    K[4+c4, 1+c3] += detJ*wij*(N3x*(B26*N4y + B66*N4x) + N3y*(B22*N4y + B26*N4x))
    K[4+c4, 2+c3] += detJ*wij*(A44*N3y*N4 + A45*N3x*N4)
    K[4+c4, 3+c3] += detJ*wij*(A45*N3*N4 + N3x*(D12*N4y + D16*N4x) + N3y*(D26*N4y + D66*N4x))
    K[4+c4, 4+c3] += detJ*wij*(A44*N3*N4 + Ephiy*gamma3*gamma4 + N3x*(D26*N4y + D66*N4x) + N3y*(D22*N4y + D26*N4x))
    K[4+c4, 0+c4] += detJ*wij*(N4x*(B12*N4y + B16*N4x) + N4y*(B26*N4y + B66*N4x))
    K[4+c4, 1+c4] += detJ*wij*(N4x*(B26*N4y + B66*N4x) + N4y*(B22*N4y + B26*N4x))
    K[4+c4, 2+c4] += detJ*wij*(A44*N4*N4y + A45*N4*N4x)
    K[4+c4, 3+c4] += detJ*wij*(A45*N4**2 + N4x*(D12*N4y + D16*N4x) + N4y*(D26*N4y + D66*N4x))
    K[4+c4, 4+c4] += detJ*wij*(A44*N4**2 + Ephiy*gamma4**2 + N4x*(D26*N4y + D66*N4x) + N4y*(D22*N4y + D26*N4x))
    ...
    for quad in quads:
        ...
        for wi, xi in weights_points:
            for wj, eta in weights_points:
                ...
                Qx = A44*N1*u[4] + A44*N2*u[9] + A44*N3*u[14] + A44*N4*u[19] + A45*N1*u[3] + A45*N2*u[8] + A45*N3*u[13] + A45*N4*u[18] + u[12]*(A44*N3y + A45*N3x) + u[17]*(A44*N4y + A45*N4x) + u[2]*(A44*N1y + A45*N1x) + u[7]*(A44*N2y + A45*N2x)
                Qy = A45*N1*u[4] + A45*N2*u[9] + A45*N3*u[14] + A45*N4*u[19] + A55*N1*u[3] + A55*N2*u[8] + A55*N3*u[13] + A55*N4*u[18] + u[12]*(A45*N3y + A55*N3x) + u[17]*(A45*N4y + A55*N4x) + u[2]*(A45*N1y + A55*N1x) + u[7]*(A45*N2y + A55*N2x)
